        ...
        <div id="sit_ov_wrap">
	        ...
	        for($i=1; $i<=10; $i++) {
	            if(!$it['it_img'.$i])
                    ...
                    echo $img = get_item_new_image($it['it_id'],500,500, $it['it_name']);
	        }
	        ...
	        ?>
                ...
                <div id="sit_ov_btn">
                   ...
                   if(array_key_exists($it['it_id'], $my_wish)){
                    ...
                    echo "<button type=\"button\" class=\"btn_wish {$in_wish} sit_btn_wish {$it['it_id']}\"
                        data-it_id=\"{$it['it_id']}\"><span class=\"sound_only\">위시리스트</span><i class=\"fa fa-heart-o\"
