...
<!-- 오늘 본 상품 시작 { -->
<div id="stv">
    <h2 class="s_h2">오늘 본 상품<span class="get_today_item_count"><?php echo get_view_today_items_count(); ?></span>
    </h2>
    ...
    $(function() {
        ...
        if (itemQty > itemShow) {
            $('#stv_btn').append(
                '<button type="button" id="up"><i class="fa fa-angle-left" aria-hidden="true"></i> 이전</button><button type="button" id="down">다음 <i class="fa fa-angle-right" aria-hidden="true"></i></button>'
            );
        }
        var Flag = 1; // 페이지
