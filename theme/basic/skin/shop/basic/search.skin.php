...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <ul id="ssch_sort_all">
            <li>
                <a class="<?php if ($qsort == 'it_sum_qty') {?>active<?php } else{ ?>  <?php } ?>" href=" #"
                    onclick="set_sort('it_sum_qty', 'desc'); return false;">판매많은순</a>
            </li>
            <li>
                <a class="<?php if ($qsort == 'it_price' && $qorder == 'asc') {?>active<?php } else{ ?>  <?php } ?>"
                    href="#" onclick="set_sort('it_price', 'asc'); return false;">낮은가격순</a>
            </li>
            <li>
                <a class="<?php if ($qsort == 'it_price'  && $qorder == 'desc') {?>active<?php } else{ ?>  <?php } ?>"
                    href="#" onclick="set_sort('it_price', 'desc'); return false;">높은가격순</a>
            </li>
            <li>
                <a class="<?php if ($qsort == 'it_use_avg') {?>active<?php } else{ ?>  <?php } ?>" href="#"
                    onclick="set_sort('it_use_avg', 'desc'); return false;">평점높은순</a>
            </li>
            <li>
                <a class="<?php if ($qsort == 'it_use_cnt') {?>active<?php } else{ ?>  <?php } ?>" href="#"
                    onclick="set_sort('it_use_cnt', 'desc'); return false;">후기많은순</a>
            </li>
            <li>
                <a class="<?php if ($qsort == 'it_update_time') {?>active<?php } else{ ?>  <?php } ?>" href="#"
                    onclick="set_sort('it_update_time', 'desc'); return false;">최근등록순</a>
            </li>
        </ul>
        <!-- } 상세검색 항목 끝 -->
    </div>
