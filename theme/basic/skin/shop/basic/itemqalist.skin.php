...
<div id="sqa">
    ...
    <li>
        ...
        <section class="sqa_section">
            <h2 class="sqa_title"><?php echo $iq_subject; ?></h2>
            ...
            <div class="sqa_con_btn" style="display:none"><button class="sqa_con_<?php echo $i; ?>">내용보기 <i
...
$(function() {
    // 상품문의 더보기
    $(".sqa_title").click(function() {
        var $con = $(this).next().next().next();
        console.log($con);
        if ($con.is(":visible")) {
            $con.slideUp();
        } else {
