            ...
            <div class="register_form_inner">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" style="<?php if($member['mb_id']) { ?> background-color: #cecece;  <?php }?>"
                            name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?>
                            <?php echo $readonly ?>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" id="reg_mb_name" name="mb_name"
                            ...
                            <?php echo $readonly; ?>
                            class="frm_input full_input <?php echo $required ?> <?php echo $name_readonly ?>" size="10"
                            placeholder="이름">
                    </li>
                    <?php if ($req_nick) {  ?>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="mb_email"
                            ...
                            required class="frm_input email full_input required" size="70" maxlength="100"
                            placeholder="E-mail">
                    </li>
                    ...
                    <li>
                        ...
                        <label for="reg_mb_hp">휴대폰번호<?php if (!empty($hp_required)) { ?>
                    ...
                    <li>
                        <label for="reg_mb_icon" class="frm_label">
                            ...
                            <span class="tooltip">이미지 크기는 가로 <?php echo $config['cf_member_icon_width'] ?>픽셀, 세로
                                ...
                                gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트
                                이하만 등록됩니다.</span>
                        </label>
                    ...
                    <li class="reg_mb_img_file">
                        <label for="reg_mb_img" class="frm_label">
                            ...
                            <span class="tooltip">이미지 크기는 가로 <?php echo $config['cf_member_img_width'] ?>픽셀, 세로
                                ...
                                gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_img_size']) ?>바이트
                                이하만 등록됩니다.</span>
                        </label>
