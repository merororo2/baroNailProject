                ...
                if ($score = get_star_image($it['it_id'])) { ?>
                    ...
                    <div id="sit_btn_opt">
                        ...
                        $in_wish = '';
                           ...
                           if(array_key_exists($it['it_id'], $my_wish)){
                            $in_wish = 'get_itemwish';
                              
                           }

                         echo "<button type=\"button\" class=\"btn_wish {$in_wish}\" data-it_id=\"{$it['it_id']}\"><span class=\"sound_only\">위시리스트</span><i class=\"fa fa-heart-o\" aria-hidden=\"true\"></i></button>\n";
                            
                            ?>
                        <span class="btn_wish_num"><?php echo get_wishlist_count_by_item($it['it_id']); ?></span>
                        ...
                        <div class="sns_area">
                            ...
                            <?php echo get_sns_share_link('kakaotalk', $sns_url, $sns_title, G5_MSHOP_SKIN_URL.'/img/kakao.png'); ?>
                            <?php
    ...
    <div id="btn_option">
        ...
        ?>
                <ul id="sit_opt_added">
                    <li class="sit_opt_list">
                        ...
                        <div class="opt_count">
                            ...
                            <?php if($option_item) { ?> <span class="sit_opt_prc">+0원</span> <?php } ?>
                            <?php if(!$option_item) { ?>
                            <span class="sit_opt_prc"><?php echo display_price(get_price($it)); ?></span>
                            <input type="hidden" id="it_price" value="<?php echo get_price($it); ?>">
            ...
            <div id="sit_ov_btn">
                ...
                <?php } ?>
                <?php
                   echo "<button type=\"button\" class=\"btn_wish {$in_wish} sit_btn_wish  {$it['it_id']}\" data-it_id=\"{$it['it_id']}\"><span class=\"sound_only\">위시리스트</span><i class=\"fa fa-heart-o\" aria-hidden=\"true\"></i></button>\n";
...
function popup_item_recommend(it_id) {
    if (!g5_is_member) {
        if (confirm("회원만 추천하실 수 있습니다."))
            ...
            "<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo urlencode(shop_item_url($it_id)); ?>";
    } else {
