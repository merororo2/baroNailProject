...
<div id="ssch">
    ...
    <div id="ssch_frm">
        <form name="frmdetailsearch">
            ...
            <div class="sch_wr">
                ...
                <button type="submit" class="sch_submit"><span class="sound_only">검색</span><i
            ...
            <div class="chk_box">
                ...
                <input type="checkbox" name="qname" id="ssch_qname" <?php echo $qname_check?'checked="checked"':'';?>
                    class="selec_chk"> <label for="ssch_qname"><span></span>상품명</label>
                <input type="checkbox" name="qexplan" id="ssch_qexplan"
                    <?php echo $qexplan_check?'checked="checked"':'';?> class="selec_chk"> <label
                    for="ssch_qexplan"><span></span> <span class="sound_only">상품</span>설명</label>
                <input type="checkbox" name="qbasic" id="ssch_qbasic" value="1"
                    <?php echo $qbasic_check?'checked="checked"':'';?> class="selec_chk"> <label
                    for="ssch_qbasic"><span></span> 기본설명</label>
                <input type="checkbox" name="qid" id="ssch_qid" <?php echo $qid_check?'checked="checked"':'';?>
                    class="selec_chk"> <label for="ssch_qid"><span></span><span class="sound_only"> 상품</span>코드</label>
                <br>
                ...
                <input type="text" name="qto" value="<?php echo $qto; ?>" id="ssch_qto" class="frm_input" size="6">
                원<br>
            </div>
        </form>
    </div>
    ...
    <div id="ssch_sort">
        <button type="button" class="btn_sort">
            <?php if($qsort == '') echo "상품정렬" ?>
            <?php if($qsort == 'it_sum_qty')  echo '판매많은순' ?>
            <?php if($qsort == 'it_price' && $qorder == 'asc')  echo '낮은가격순' ?>
            <?php if($qsort == 'it_price' && $qorder == 'desc')  echo '높은가격순' ?>
            <?php if($qsort == 'it_use_avg')  echo '평점높은순' ?>
            <?php if($qsort == 'it_use_cnt')  echo '후기많은순' ?>
            <?php if($qsort == 'it_update_time')  echo '최근등록순' ?>
