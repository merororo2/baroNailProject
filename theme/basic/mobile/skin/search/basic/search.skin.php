...
<form name="fsearch" onsubmit="return fsearch_submit(this);" method="get">
    ...
    <fieldset id="sch_res_detail">
        ...
        <div class="sch_wr">
            ...
            <input type="text" name="stx" id="stx" value="<?php echo $text_stx ?>" class="frm_input" required
                maxlength="20">
...
<div id="sch_result">
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
            <h2><a href="<?php echo get_pretty_url($search_table[$idx], '', $search_query); ?>"><?php echo $bo_subject[$idx] ?>
                    게시판 내 결과</a></h2>
            <ul>
                <?php
         ...
         ?>
                <li>
                    <div class="sch_res_title">
                        <a
                            href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>"><?php echo $comment_def ?><?php echo $list[$idx][$i]['subject'] ?></a>
                    ...
                    <div class="sch_res_info">
                        ...
                        <span class="sch_datetime"><i class="fa fa-clock-o" aria-hidden="true"></i>
                            <?php echo $list[$idx][$i]['wr_datetime'] ?></span>
                    </div>
                </li>
                <?php }  ?>
            </ul>
            <div class="sch_more"><a
                    href="<?php echo get_pretty_url($search_table[$idx], '', $search_query); ?>"><strong><?php echo $bo_subject[$idx] ?></strong>
                    결과 더보기</a></div>
            <?php }  ?>
