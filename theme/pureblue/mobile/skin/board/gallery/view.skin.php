...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header class="bo_top_hd">
        ...
        <div id="bo_v_info">
        	...
        	<div class="profile_info">
        		...
        		<span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $view['wr_datetime'] ?></span>
        		<a href="#bo_vc" class="bo_vc_btn"><span class="sound_only">댓글</span><i class="fa fa-commenting-o" aria-hidden="true"></i> <?php echo $view['wr_comment'] ?></a>
        	</div>
        </div>
        <div id="bo_v_option">
    ...
    <ul class="bo_v_nb">
        <?php if ($prev_href) { ?><li class="bo_v_prev"><a href="<?php echo $prev_href ?>"><i class="fa fa-angle-up"></i> 이전글</a></li><?php } ?>
        <?php if ($next_href) { ?><li class="bo_v_next"><a href="<?php echo $next_href ?>"><i class="fa fa-angle-down"></i> 다음글</a></li><?php } ?>
    </ul>
    <?php } ?>
