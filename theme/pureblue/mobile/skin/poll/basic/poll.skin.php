...
<aside id="poll">
    ...
    <div class="q_poll">
    	...
    	<a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn btn_b01">결과보기 <i class="fa fa-angle-right"></i></a>
    </div>
    <ul class="qali_poll">
    ...
    <footer>
        <button type="submit" class="btn btn_b02">투표하기</button>
	</footer>
</aside>
</form>
