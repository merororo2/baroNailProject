...
<div id="sod_ws">
    ...
    <form name="fwishlist" method="post" action="./cartupdate.php">
        ...
        ?>
                ...
                <li>
                    <div class="sod_ws_img"><a
                            href="<?php echo shop_item_url($row['it_id']); ?>"><?php echo $image; ?></a></div>
                    <div class="wish_info">
                        <div class="wish_chk">
                            <?php
                    // 품절검사
        ...
        <div id="sod_ws_act">
            <button type="submit" class="btn01" onclick="return fwishlist_check(document.fwishlist,'');">장바구니
                담기</button>
